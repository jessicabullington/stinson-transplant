...
Purpose: Create figures and perform data analysis for the Feb/Mar 2022 Manuscript that summarizes the sampling methods and resulting data as well as dives into the effects of the overtopping event
...
# STEP 1: Import phyloseq object that has the negative control ASVs and singletons filtered out
...
# ordination
```{r}
sample_data(ps_new)$Day <- as.factor(as.character(sample_data(ps_new)$Day))
